...
export default function YourSounds() {
  ...
  <main className="flex flex-col items-start justify-start pt-28 pl-40 pr-8 gap-0">
    <div className="flex flex-row w-full gap-12">
  <h2 className="text-5xl font-bold mb-0 text-left whitespace-nowrap ml-32 mt-8">Your Sounds</h2>
  <div className="max-w-2xl text-sm text-gray-700 text-left flex-1 mt-4 ml-8 mr-12 mb-4">
  <p className="mb-3 mr-32 mt-8 font-serif">
  Here you can find individual sounds and words contributed by people connected to Vaglio, even if living elsewhere, all part of a sonic thread that links the community across distance.
    </p>
