...
function AudioPlayerBar({ isPlaying, onPlayPause, currentTime, duration, onBarClick, volume, onVolumeChange }: AudioPlayerBarProps) {
  ...
  return (
    <div className="w-full flex items-center gap-4">
      ...
      <button
        className="text-gray-700 hover:text-indigo-500 p-2 rounded-full focus:outline-none"
        onClick={onPlayPause}
      ...
      >
        {isPlaying ? (
          ...
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <rect x="6" y="5" width="4" height="14" rx="2" fill="#333" />
...
export default function BinauralComposition() {
  ...
  return (
    <div className="relative bg-white text-black min-h-screen w-full overflow-y-auto">
  ...
  {/* ...existing code... (no menu below the title) */}
      ...
      <main className="flex flex-1 w-full h-full pt-24 px-8 gap-8 items-start justify-center">
        ...
        <div className="flex flex-col items-center justify-center w-full max-w-xl mx-auto md:hidden">
          <h2 className="text-3xl font-bold -mt-6 mb-8 text-center w-full md:mt-24">Binaural Composition</h2>
