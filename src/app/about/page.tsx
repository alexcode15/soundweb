...
export default function About() {
  ...
  <h2 className="text-3xl font-bold mt-10 mb-8 text-center md:mt-24 md:mb-24">About</h2>
  <p className="text-sm leading-relaxed text-black mb-8 text-justify font-serif md:text-base md:mb-16">
  ...
  <p className="text-gray-500 italic text-sm leading-relaxed text-justify font-serif italic mb-24 md:text-base md:mb-0">
